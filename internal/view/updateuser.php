        ...
        <div id="maindiv">
           ...
           class="navbar navbar-default navbar-inverse navbar-fixed-top">                
            ...
            <div id="navidiv">
                ...
                &nbsp;</div>
            <div id="contentdiv">
                <div class="dash">Update a User</div>
                <hr />
                <div id="msg"></div>
                <div class="container-fluid"> 
<form method="post" action="../controller/usercontroller.php?status=Add"
 ...
 <div class="col-md-4 col-sm-6 col-xs-12"> 
     <input type="text" name="user_fname" id="user_fname" 
            ...
            value="<?php echo $rowu['user_fname']; ?>"/>
     <span>*</span>
 </div>
 <div class="col-md-2 col-sm-6 col-xs-12"> 
 ...
 <div class="col-md-4 col-sm-6 col-xs-12">
     <input type="text" name="user_lname" id="user_lname" 
            ...
            value="<?php echo $rowu['user_lname']; ?>"
            />
             <span>*</span>
 </div>                 
                    </div> 
 ...
 <div class="col-md-4 col-sm-6 col-xs-12">
     <input type="radio" name="user_gender" id="male" 
      <?php if(strtolower($rowu['user_gender'])=="male") {
          echo "checked";
      }      ?>
            value="Male" class="input-group-lg" /> Male
     <input type="radio" name="user_gender" id="female" 
            value="Female" class="input-group-lg"            
            <?php if(strtolower($rowu['user_gender'])=="female") {
          echo "checked";
      }      ?>
            />Female <br />
      <span>*</span>
 ...
 <div class="col-md-4 col-sm-6 col-xs-12"> 
     <input type="text" name="user_tel" id="user_tel" 
            ...
            <?php echo $rowu['user_tel']; ?>/>
 </div>
 <div class="col-md-2 col-sm-6 col-xs-12"> 
     <label>Address</label></div>
 <div class="col-md-4 col-sm-6 col-xs-12">
     <textarea name="user_add" id="user_add" class="form-control">
 ...
 <div class="col-md-4 col-sm-6 col-xs-12"> 
     ...
     <select name="role_id" id="role_id" class="form-control">
         ...
         <option value="<?php echo $row[0]; ?>" 
                 <?php
           if($row['role_id']==$rowu['role_id']){ echo "selected"; } 
                 ?>               
                 >
