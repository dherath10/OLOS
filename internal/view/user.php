...
$result = $obj->viewAllUser(); //To get all users' infor
$nou = $result->num_rows;
    ...
    <body>
        <div id="maindiv">
            ...
            <div id="navidiv">
                ...
                &nbsp;</div>
            <div id="contentdiv">
                <div class="dash">User Module</div>
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        while ($row = $result->fetch_array()) {
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    &nbsp;</td>
                                <td>
<a href="../view/viewuser.php?user_id=<?php echo $row['user_id']; ?>&status=View"><button type="button" class="btn btn-success">View</button>
 </a>
 <a href="../view/updateuser.php?user_id=<?php echo $row['user_id']; ?>&status=Update">
